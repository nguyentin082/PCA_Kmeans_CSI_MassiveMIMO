...
H_reconstructed{1} = load('HDL_ori_reconst-BTot512-Ntrain2000-CR64.mat').HDL_ori_reconst;
H_reconstructed{2} = load('HDL_ori_reconst-BTot768-Ntrain2000-CR64.mat').HDL_ori_reconst;
H_reconstructed{3} = load('HDL_ori_reconst-BTot1024-Ntrain2000-CR64.mat').HDL_ori_reconst;
H_reconstructed{4} = load('HDL_ori_reconst-BTot1280-Ntrain2000-CR64.mat').HDL_ori_reconst;
H_reconstructed{5} = load('HDL_ori_reconst-BTot1536-Ntrain2000-CR64.mat').HDL_ori_reconst;
H_reconstructed{6} = load('HDL_ori_reconst-BTot1792-Ntrain2000-CR64.mat').HDL_ori_reconst;
H_reconstructed{7} = load('HDL_ori_reconst-BTot2048-Ntrain2000-CR64.mat').HDL_ori_reconst;
...
save('avg_sum_rates_CR64.mat', 'avg_sum_rates');
