...
% Parameters
na = 32;                % # of BS antennas
nc = 80;               % # of OFDM subcarriers
nTrain = 1500;          % # of training samples
nTest = 2000;           % # of test samples
CR = 16;                % Compression ratio
BTot = 1536;           % Total feedback bits
...
save(['rho-BTot',num2str(BTot),'Ntrain',num2str(nTrain),'-CR',num2str(CR),'.mat'],'rho')
