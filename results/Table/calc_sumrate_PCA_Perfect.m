...
H_reconstructed{1} = load('HDL_ori_reconst-BTot2048-Ntrain5000-CR32.mat').HDL_ori_reconst;
H_reconstructed{2} = load('HDL_ori_reconst-BTot2048-Ntrain5000-CR64.mat').HDL_ori_reconst;
...
% SNR values
snr_values = 0:5:10; % SNR values in dB
