...
clear; close all; clc;
% rng(1);
rng('shuffle'); % Sử dụng shuffle để có seed ngẫu nhiên khác nhau mỗi lần chạy
...
if plotFigs
    l.visualize([],[],0);
    view(30, 60);
    title('Simulation of data generation (7000 samples) with QuaDRiGa.', 'FontSize', 16, 'FontWeight', 'bold');
